                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Theme Appearance Section</h3>
                                                    ...
                                                    <?php
                                                     ...
                                                     if(mysqli_num_rows($data)>0){
                                                       while($dataall =  mysqli_fetch_assoc($data)){
                                                         echo '<tr>
                                                         <td class="text-bold-500">'. $dataall["id"].'</td>
                                                         <td><a href='. $dataall["id"].'>'. $dataall["catname"].'</td>
                                                         </tr>';
                                                       } 
                                                     }
                                                    ?>
                            ...
                            <h4 class="card-title">Add a New Course</h4>
                             ...
                             <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                    <div class="form-group">
                                        <label for="basicInput">Add New Course Catagrey</label>
                                        <input type="text" class="form-control" id="basicInput"
                                            placeholder="Add New Catagrey" name="NewCatagrey">
                                    </div>
                                    <input type="submit" class="btn btn-outline-primary float-right" name="addcat">                                    
                             </form>
                ...
                <section id="input-style">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Theme Appearance And Tagline  </h4>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <p>
                                            Adding Text and Tage line for edding first box And Update you Text.
                                             </p>
                                        </div>
                                        <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="roundText" class="form-control round"
                                                     name="tagline"  value="<?php echo $tagline;?>" >
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                           <div class="form-group mb-3">
                                           <label for="exampleFormControlTextarea1" class="form-label">Example textarea</label>
                                           <textarea class="form-control" id="exampleFormControlTextarea1" name="aptextbox" rows="3"
                                           >
                                           <?php echo $textbox;?>
                                           </textarea>
                                            </div>
                                          <input type="submit" class="btn btn-outline-primary float-right" name="textadd">                                     </div>
                                        <form>
