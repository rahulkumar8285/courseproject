                                ...
                                <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="roundText" class="form-control round" name="tagline"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" id="exampleFormControlTextarea1"
                                                name="aptextbox" rows="3">
                                           <?php echo $textbox;?>
                                           </textarea>
                                        </div>
                                        <input type="submit" class="btn btn-outline-primary float-right" name="textadd">
                                    </div>
                                    <form>
