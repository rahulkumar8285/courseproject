                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Total Student</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Total Student <?php echo TotalNumbers('student');?></h4>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        <?php
                                                     $Num =1;
                                                     $data = ShowData('student');
                                                     if(mysqli_num_rows($data)>0){
                                                       while($dataall =  mysqli_fetch_assoc($data)){?>
                                        <tr>
                                            <td class="text-bold-500"><?php echo $Num; ?></td>
                                            <td><?php echo $dataall['id'];?></td>
                                            <td class="text-bold-500"><a href="#"><?php echo $dataall["name"]?></a>
                                            </td>
                                            <td><?php echo $dataall['email']?></td>
                                            <td><?php echo $dataall["mobile"] ;?></td>
                                            <td><?php echo $dataall["city"] ;?></td>
                                            <td><?php echo $dataall["country"] ;?></td>
