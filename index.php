                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-6 col-lg-7 col-md-8">
                                <div class="hero__caption">
                                    ...
                                    <!-- Hero-btn -->
                                    <div class="hero__btn">
                                        <a href="industries.php" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s">Get Started</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-between">
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="single-counter text-center">
                                        ...
                                        <span class="counter color-green"><?php echo TotalNumbers('course');?></span>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="single-counter text-center">
                                        ...
                                        <span class="counter color-blue"><?php echo TotalNumbers('student');?></span>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="single-counter text-center">
                                        ...
                                        <span class="counter color-green"><?php echo TotalNumbers('coursecat');?></span>
                                        <p class="color-green">+ Catagrey</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <!-- Counter Up -->
                                    <div class="single-counter text-center">
                                        ...
                                        <span class="counter color-red"><?php echo TotalNumbers('facility');?></span>
                                        <p class="color-red">+ Facility</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-course mb-40">
                            ...
                            <div class="course-caption">
                                <div class="course-cap-top">
                                    <h4><a href="course-single.php?cid=<?php echo $row['id'] ?>"><?php echo ucwords($row['coursename']);?></a></h4>
                                </div>
                                <p>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-caption">
                                <h3><a href="instructor.php">Alexa Janathon</a></h3>
                                <p>Faculty</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-caption">
                                <h3><a href="instructor.php">Janathon Smith</a></h3>
                                <p>Faculty</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-caption">
                                <h3><a href="instructor.php">Alexa MacCalum</a></h3>
                                <p>Faculty</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-caption">
                                <h3><a href="instructor.php">Alexa j Watson</a></h3>
                                <p>Faculty</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="browse-btn2 text-center mt-70">
                            <a href="instructor.php" class="btn white-btn">View All Faculty</a>
                        </div>
                    </div>
                </div>
            </div>
