                                                    ...
                                                    <form action="/upload" class="dropzone dropzone-custom needsclick addcourse" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="duration" type="text" class="form-control" placeholder="Course Leacher">
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="country" class="form-control">
                                                                            ...
                                                                            <?php $result = ShowData("coursecat");
                                                                             ...
                                                                             echo '<option value="<?php echo $row['id']; ?>"><?php echo $row['catname']; ?></option>';
															               <?php }?>
																		</select>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <textarea rows="2" name="short-description" placeholder="Short Description"
